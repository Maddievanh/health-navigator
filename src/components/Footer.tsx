        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/" className="hover:text-primary transition-colors">Find Care</Link></li>
              <li><Link to="/" className="hover:text-primary transition-colors">AI Assistant</Link></li>
